          ...
          child: Column(
            ...
            children: [
              ...
              _buildTextField(
                ...
                _bioController,
                maxLines: 4,
                hint: "Tell them something interesting...",
              ),
              ...
              _buildSelectionTile(
                Icons.school,
                "Education",
                _selectedEducation ?? "Add",
                () => _showPicker("Education", [
                  "Bachelors",
                  "Masters",
                  "PhD",
                  "High School",
              ...
              _buildSelectionTile(
                Icons.church,
                "Religion",
                _selectedReligion ?? "Add",
                () => _showPicker("Religion", [
                  "Orthodox",
                  "Muslim",
                  "Protestant",
                  "Catholic",
          ...
          GestureDetector(
            ...
            child: CircleAvatar(
              ...
              child: imageProvider == null
                  ? const Icon(Icons.add_a_photo, color: habeshaGold, size: 40)
                  : null,
            ),
          ),
      ...
      trailing: Row(
        ...
        children: [
          Text(
            value,
            style: TextStyle(
              color: value == "Add" ? Colors.white24 : habeshaGold,
              fontSize: 15,
            ),
          ),
